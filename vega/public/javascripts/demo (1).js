...
var events = [ {
    id: "imwyx6S",
    name: "Event #3",
    description: "AMAZON HIRING OF THE DAY",
    date: today.getMonth() + 1 + "/18/" + today.getFullYear(),
    type: "event"
}, {
    id: "9jU6g6f",
    name: "Holiday #1",
    description: "TECHNICAL ROUNDS OF WIPRO",
    date: today.getMonth() + 1 + "/10/" + today.getFullYear(),
    type: "holiday"
}, {
    id: "0g5G6ja",
    name: "Event #1",
    description: "HR INTERVIEW OF AMAZON",
    ...
    id: "y2u7UaF",
    name: "Holiday #3",
    description: "TECHNICAL ROUND OF INFOSYS",
    date: today.getMonth() + 1 + "/23/" + today.getFullYear(),
    type: "holiday"
}, {
    id: "dsu7HUc",
    name: "Birthday #1",
    description: "CODING CHALLENGE OF DELLOITE",
    date: new Date(),
    type: "birthday"
}, {
    id: "dsu7HUc",
    name: "Birthday #2",
    description: "CODING CHALLENGE OF GOOGLE",
...
$(document).ready(function() {
    $("#demoEvoCalendar").evoCalendar({
        ...
        calendarEvents: [{
            ...
            description: "CODING CHALLENGE OF MICROSOFT",
            badge: "5-day event",
            ...
            id: "in8bha4",
            name: "EVENT OF WIPRO",
            description: "CODING CHALLENGE OF WIPRO",
            date: today,
            type: "EVENT"
        }, {
            id: "in8bha4",
